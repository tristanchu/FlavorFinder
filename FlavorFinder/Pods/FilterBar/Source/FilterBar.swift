...
//    @available(iOS, introduced=1.0.0, deprecated=2.0.0, renamed="barTintColor") var color : UIColor = UIColor.whiteColor() {
//        didSet(newColor) {
//            self.barTintColor = newColor
//        }
//    }
//    
//    @available(iOS, introduced=1.0.0, deprecated=2.0.0) var borderColor : UIColor = UIColor.blackColor()
    ...
    override func layoutSubviews() {
        ...
        let containsWhiteView : Bool = (self.subviews as! Array<UIView>).contains(self._whiteOverlay)
        ...
        let containsColorView : Bool = (self.subviews as! Array<UIView>).contains(self._colorOverlay)
